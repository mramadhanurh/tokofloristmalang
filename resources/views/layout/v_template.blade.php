...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title>Dashboard - Kemuning Florist Malang</title>
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                        <span class="user-icon">
                            <img src="{{ asset('template') }}/vendors/images/7816916.png" alt="" />
                        </span>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="index.html">
                ...
                <img src="{{ asset('template') }}/vendors/images/deskapp-logo-white.svg" alt="" class="light-logo" />
            </a>
